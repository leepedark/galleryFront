<template>
  <header>
        ...
        <div class="row">
          <div class="col-sm-4">
            ...
            <ul class="list-unstyled">
              ...
              <li>
                <router-link to="/join" class="text-white">회원가입</router-link>
              </li>
              <li>
    ...
    <div class="navbar navbar-dark bg-dark shadow-sm">
      <div class="container">
        <router-link to="/" a href="#" class="navbar-brand d-flex align-items-center">
  ...
  setup() {
    const logout = () => {
      axios.post("/api/account/logout").then((res) => {
        ...
        // window.alert(store.state.account.id);
        router.push({path: "/"})
      })
    }
    return {logout}
